...
#     new_arr = arr.select {|ele| (prc1.call(ele) && prc2.call(ele)) || (!prc1.call(ele) && !prc2.call(ele)) }
# end 
...
#     arr.map! {|num| prc1.call(num) ? prc2.call(num) : num }
#     return nil 
# end 
...
#     arr.inject(num) {|acc, el| el.call(acc) }
# end
...
#     words.each do |word|
#         new_word = word
#         hash.each { |k, v| new_word += hash[k] if k.call(word) }
#         new_sent << new_word
#     end 
#     new_sent.join(' ')
# end 
